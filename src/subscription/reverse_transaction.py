...
class ReverseTransactionAPI:
    ...
    def __init__(self):
        self._status_code = ''
        self._status_desc = ''
        self._tx_type = 'automaticPayment'
        self._rest_endpoint = '/subscriptions/v2/-services-reverseservices-reversetransaction'
    ...
    def reverse_subscription_payment(self, phone: str, code: str, value: str, message_id: str) -> None:
        try:
            self._call(phone, code, value, message_id)
        except Exception as e:
            print(f'Pagos con suscripción -> Error realizando la reversión de la transacción -> {e}')
